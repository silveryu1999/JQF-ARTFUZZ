...
../../bin/jqf-rank -c .:$(../../scripts/classpath.sh):ant-1.10.1.jar:ant-launcher-1.10.1.jar:plexus-utils-3.1.0.jar:commons-lang3-3.12.0.jar -l -b ProjectBuilderTest testWithGenerator rank-0/