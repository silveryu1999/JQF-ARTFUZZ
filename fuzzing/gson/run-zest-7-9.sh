...
../../bin/jqf-art -c .:$(../../scripts/classpath.sh):$(./classpath.sh) -b JsonTest fuzzJSONParser jqf-zest-7/
../../bin/jqf-art -c .:$(../../scripts/classpath.sh):$(./classpath.sh) -b JsonTest fuzzJSONParser jqf-zest-8/
../../bin/jqf-art -c .:$(../../scripts/classpath.sh):$(./classpath.sh) -b JsonTest fuzzJSONParser jqf-zest-9/