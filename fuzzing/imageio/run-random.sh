...
export JVM_OPTS="$JVM_OPTS -Djqf.ei.TRIAL_LIMIT=10000000"
export JVM_OPTS="$JVM_OPTS -Djqf.ei.TIME_LIMIT=3h"
export JVM_OPTS="$JVM_OPTS -Xmx40g"
export JVM_OPTS="$JVM_OPTS -Djqf.ei.MAP_SIZE_POW=14"
../../bin/jqf-art -c .:$(../../scripts/classpath.sh):$(./classpath.sh) -l -b PngReaderTest readUsingKaitai jqf-random/