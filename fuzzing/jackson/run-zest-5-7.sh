...
../../bin/jqf-art -c .:$(../../scripts/classpath.sh):$(./classpath.sh) -b JsonTest fuzzJsonReadValue jqf-zest-6/
../../bin/jqf-art -c .:$(../../scripts/classpath.sh):$(./classpath.sh) -b JsonTest fuzzJsonReadValue jqf-zest-7/