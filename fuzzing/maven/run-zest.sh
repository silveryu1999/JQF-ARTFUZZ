...
../../bin/jqf-art -c .:$(../../scripts/classpath.sh):maven-model-3.5.2.jar:maven-model-builder-3.5.2.jar:plexus-utils-3.1.0.jar:commons-lang3-3.12.0.jar -l -b ModelReaderTest testWithGenerator jqf-zest/